...
public class Trace {
     ...
     * 设置日志保存路径
     *
     * @param absolutePath /sdcard/seven.log
     */
    public static void setLogAbsolutePath(@NonNull String absolutePath) {
        s_log_path = absolutePath;
    }

    /**
     * 日志文件的绝对路径:/sdcard/xxx/seven_log.txt
     */
    ...
    public static void v(String tag, String msg, boolean minify) {
        println(2, tag, msg, minify);
    }
    ...
    public static void v(String tag, String msg, boolean minify, Object... args) {
        println(2, tag, String.format(msg, args), minify);
    }
    ...
    public static void d(String tag, String msg, boolean minify) {
        println(3, tag, msg, minify);
    }
    ...
    public static void d(String tag, String msg, boolean minify, Object... args) {
        println(3, tag, String.format(msg, args), minify);
    }
    ...
    public static void i(String tag, String msg, boolean minify) {
        println(4, tag, msg, minify);
    }
    ...
    public static void i(String tag, String msg, boolean minify, Object... args) {
        println(4, tag, String.format(msg, args), minify);
    }
    ...
    public static void w(String tag, String msg, boolean minify, Object... args) {
        println(5, tag, String.format(msg, args), minify);
    }
    ...
    public static void w(String tag, String msg, boolean minify) {
        println(5, tag, msg, minify);
    }
    ...
    public static void e(String tag, String msg, boolean minify) {
        println(6, tag, msg, minify);
    }
    ...
    public static void e(String tag, String msg, Throwable tr, boolean minify) {
        println(6, tag, msg + '\n' + getStackTraceString(tr), minify);
    }
    ...
    public static void e(String tag, Throwable tr, boolean minify) {
        println(6, tag, getStackTraceString(tr), minify);
    }
    ...
    public static void json(String tag, String json, boolean minify) {
        s_offset = 1;
        if (TextUtils.isEmpty(json)) {
            e(tag, "Empty/Null json content", minify);
            return;
        }
        try {
            json = json.trim();
    ...
    public static void xml(String tag, String xml, boolean minify) {
        s_offset = 1;
        if (TextUtils.isEmpty(xml)) {
            e(tag, "Empty/Null xml content", minify);
            return;
        }
        try {
            Source xmlInput = new StreamSource(new StringReader(xml));
    ...
    public static void file(String tag, File file, boolean minify) {
        s_offset = 1;
        if (file == null || !file.exists()) {
            e(tag, "Empty/Null file", minify);
            return;
        }
        try {
            FileInputStream fis = new FileInputStream(file);
    ...
    private static void println(int level, String tag, String message) {
        println(level, tag, message, false);
    }

    private static void println(int level, String tag, String message, boolean minify) {
        if (level >= s_level) {//过滤级别
            if (minify) {
                message = StringMinifyUtil.replaceSpecialStr(message);
            }
            if (s_write_file) {
